                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item active">Edit Auction
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="card-body">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-4">
                          ...
                          <input value="{{$auction->auction_title}}" type="text" class="form-control" placeholder="Auction Title" name="auction_title" id="auction_title">
                        </div>

                        <div class="col-md-4">
                          <label class="label-control">Starting Date</label>
                          <input value="{{$auction->starting_date}}" type="date" class="form-control" placeholder="Starting Date" name="starting_date" id="starting_date">
                        </div>

                        <div class="col-md-4">
                          <label class="label-control">Starting Time</label>
                          <input value="{{$auction->starting_time}}" type="text" class="form-control" placeholder="Starting Time" name="starting_time" id="starting_time">
                        </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-4">
                          ...
                          <input value="{{$auction->channel_name}}" type="text" class="form-control" placeholder="Channel Name" name="channel_name" id="channel_name">
                        </div>

                        <div class="col-md-4">
                          <label class="label-control">Minimum Percentage</label>
                          <input value="{{$auction->minimum_percentage}}" type="text" class="form-control" placeholder="Minimum Percentage" name="minimum_percentage" id="minimum_percentage">
                        </div>
...
<tr value="{{$x}}" id="row{{$x}}">
	<td>
		<input value="{{$row['vehicle_id']}}" readonly type="text" name="lot[]" id="lot{{$x}}" autocomplete="off" class="form-control" />
	</td>
    <td>
    <input value="{{$row['brand']}}" readonly type="text" name="brand[]" id="brand{{$x}}" autocomplete="off" class="form-control" />
    <input value="{{$row['vehicle_id']}}" readonly type="hidden" name="vehicle_id[]" id="vehicle_id{{$x}}" />
    </td>
	<td>
		<input value="{{$row['model']}}" readonly type="text" name="model[]" id="model{{$x}}" autocomplete="off" class="form-control" readonly="true" />
	</td>
	<td>
		<input value="{{$row['vehicle_type']}}" readonly type="text" name="vehicle_type[]" id="vehicle_type{{$x}}" autocomplete="off" class="form-control" readonly="true" />
	</td>
	<td>
		<input value="{{$row['price']}}" readonly type="text" name="price[]" id="price{{$x}}" autocomplete="off" class="form-control" readonly="true" />
	</td>
	<td>
		<input value="{{$row['year']}}" readonly type="text" name="year[]" id="year{{$x}}" autocomplete="off" class="form-control" readonly="true" />
	</td>
	<td align="center">
		<button id="removeProductRowBtn{{$x}}" class="btn btn-default removeProductRowBtn" type="button" onclick="removeProductRow({{$x}})"><i class="fa fa-minus" aria-hidden="true"></i></button>
	</td>
</tr>
<?php $x++; ?>
@endforeach
