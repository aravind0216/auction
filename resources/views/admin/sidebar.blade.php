    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
                ...
                <li class=" navigation-header"><span>Vehicles</span></li>
                ...
                <li class="member nav-item">
                    <a href="/admin/member">
                        ...
                        <span class="menu-title" data-i18n="Email">Member</span>
                    </a>
                </li>

                <li class="deposit-request nav-item">
                    <a href="/admin/deposit-request">
                        <i class="menu-livicon" data-icon="users"></i>
                        <span class="menu-title" data-i18n="Email">Deposit Request</span>
                    </a>
                </li>

                <li class="withdrawal-request nav-item">
                    <a href="/admin/withdrawal-request">
                        <i class="menu-livicon" data-icon="users"></i>
                        <span class="menu-title" data-i18n="Email">Withdrawal Request</span>
                    </a>
                </li>
