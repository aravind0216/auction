                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item active">Add New Deposit
                                    </li>
                                </ol>
                            </div>
                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" value="{{Auth::user()->id}" name="member_id" id="member_id">
	          	...
	          	<div class="form-group row">
		            <label class="col-md-3 label-control">Upload Slip</label>
		            <div class="col-md-9">
		                <input type="hidden" id="image1" placeholder="image" name="image1">
